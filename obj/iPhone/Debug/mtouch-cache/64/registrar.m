...
@implementation AppDelegate { } 
	...
	-(id) window
	{
		...
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "TableviewCellaccesory.iOS.AppDelegate, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_Window");
	}

	-(void) setWindow:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIWindow, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "TableviewCellaccesory.iOS.AppDelegate, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_Window");
	}

	-(void) applicationWillResignActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "TableviewCellaccesory.iOS.AppDelegate, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "TableviewCellaccesory.iOS.AppDelegate, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "TableviewCellaccesory.iOS.AppDelegate, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillEnterForeground");
	}

	-(void) applicationWillTerminate:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIApplication, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "TableviewCellaccesory.iOS.AppDelegate, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillTerminate");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_4 (self, _cmd, &managed_method, "TableviewCellaccesory.iOS.AppDelegate, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end

@interface TableviewCellaccesory_iOSViewController : UIViewController {
	void *__monoObjectGCHandle;
}
	...
	-(bool) conformsToProtocol:(void *)p0;
@end
@implementation TableviewCellaccesory_iOSViewController { } 
	-(void) release
	{
		xamarin_release_trampoline (self, _cmd);
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "TableviewCellaccesory.iOS.TableviewCellaccesory_iOSViewController, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_tableview");
	}

	-(void) setTableview:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UITableView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "TableviewCellaccesory.iOS.TableviewCellaccesory_iOSViewController, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_tableview");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, "TableviewCellaccesory.iOS.TableviewCellaccesory_iOSViewController, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidReceiveMemoryWarning");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, "TableviewCellaccesory.iOS.TableviewCellaccesory_iOSViewController, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}

	-(void) viewWillAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "TableviewCellaccesory.iOS.TableviewCellaccesory_iOSViewController, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillAppear");
	}

	-(void) viewDidAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "TableviewCellaccesory.iOS.TableviewCellaccesory_iOSViewController, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidAppear");
	}

	-(void) viewWillDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "TableviewCellaccesory.iOS.TableviewCellaccesory_iOSViewController, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillDisappear");
	}

	-(void) viewDidDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "TableviewCellaccesory.iOS.TableviewCellaccesory_iOSViewController, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidDisappear");
	}
...
@interface TableviewCellaccesory_iOS_TableSource : UITableViewSource {
}
	-(NSInteger) tableView:(id)p0 numberOfRowsInSection:(NSInteger)p1;
	-(id) tableView:(id)p0 cellForRowAtIndexPath:(id)p1;
@end
@implementation TableviewCellaccesory_iOS_TableSource { } 

	-(NSInteger) tableView:(id)p0 numberOfRowsInSection:(NSInteger)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "System.nint, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "TableviewCellaccesory.iOS.TableSource, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "RowsInSection");
	}

	-(id) tableView:(id)p0 cellForRowAtIndexPath:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, p0, p1, "UIKit.UITableView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSIndexPath, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "TableviewCellaccesory.iOS.TableSource, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "GetCell");
	}
@end
...
@implementation CustomeCell { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "TableviewCellaccesory.iOS.CustomeCell, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_imageview");
	}

	-(void) setImageview:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "UIKit.UIImageView, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "TableviewCellaccesory.iOS.CustomeCell, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_imageview");
	}
...
@implementation __NSObject_Disposer { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, "Foundation.NSObject, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Foundation.NSObject+NSObject_Disposer, Xamarin.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Drain");
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{"AppDelegate", "TableviewCellaccesory.iOS.AppDelegate, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"TableviewCellaccesory_iOSViewController", "TableviewCellaccesory.iOS.TableviewCellaccesory_iOSViewController, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"TableviewCellaccesory_iOS_TableSource", "TableviewCellaccesory.iOS.TableSource, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"CustomeCell", "TableviewCellaccesory.iOS.CustomeCell, TableviewCellaccesory.iOS, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [4].handle = [TableviewCellaccesory_iOSViewController class];
	__xamarin_class_map [5].handle = objc_getClass ("UITableViewSource");
	__xamarin_class_map [6].handle = [TableviewCellaccesory_iOS_TableSource class];
	__xamarin_class_map [7].handle = objc_getClass ("UIView");
	__xamarin_class_map [8].handle = objc_getClass ("UITableViewCell");
	__xamarin_class_map [9].handle = [CustomeCell class];
	...
	xamarin_setup_classmap (__xamarin_class_map, 30);
}
