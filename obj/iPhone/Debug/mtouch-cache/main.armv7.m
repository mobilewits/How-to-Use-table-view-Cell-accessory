...
extern void *mono_aot_module_TableviewCellaccesory_iOS_info;
...
{
	mono_aot_register_module (mono_aot_module_TableviewCellaccesory_iOS_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "TableviewCellaccesory.iOS.exe";
